...
| qe | qe_score_entry | qe_score_entry_created_at_not_null | CHECK |
| qe | qe_score_entry | qe_score_entry_id_not_null | CHECK |
| qe | qe_score_entry | qe_score_entry_player_id_not_null | CHECK |
| qe | qe_score_entry | qe_score_entry_schema_version_not_null | CHECK |
| qe | qe_score_entry | qe_score_entry_session_id_not_null | CHECK |
...
| qe | qe_stage | qe_stage_config_not_null | CHECK |
| qe | qe_stage | qe_stage_created_at_not_null | CHECK |
| qe | qe_stage | qe_stage_id_not_null | CHECK |
| qe | qe_stage | qe_stage_plugin_key_not_null | CHECK |
| qe | qe_stage | qe_stage_seed_not_null | CHECK |
| qe | qe_stage | qe_stage_session_id_not_null | CHECK |
| qe | qe_stage | qe_stage_stage_id_not_null | CHECK |
| qe | qe_stage | qe_stage_stage_index_not_null | CHECK |
| qe | qe_stage | qe_stage_status_not_null | CHECK |
...
| qe | qe_stage_outcome_dedup_backup | qe_stage_outcome_dedup_backup_created_at_not_null | CHECK |
| qe | qe_stage_outcome_dedup_backup | qe_stage_outcome_dedup_backup_deduped_at_not_null | CHECK |
| qe | qe_stage_outcome_dedup_backup | qe_stage_outcome_dedup_backup_id_not_null | CHECK |
| qe | qe_stage_outcome_dedup_backup | qe_stage_outcome_dedup_backup_payload_not_null | CHECK |
| qe | qe_stage_outcome_dedup_backup | qe_stage_outcome_dedup_backup_session_id_not_null | CHECK |
| qe | qe_stage_outcome_dedup_backup | qe_stage_outcome_dedup_backup_stage_id_not_null | CHECK |
| qe | qe_stage_outcome_dedup_backup | qe_stage_outcome_dedup_backup_stage_index_not_null | CHECK |
| qe | qe_stage_outcome_dedup_backup | qe_stage_outcome_dedup_backup_pkey | PRIMARY KEY |
